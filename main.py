...
class MainWindow(uiclass, baseclass):
    ...
    def _import_signal_file(self):
        ...
        self.input_total_time.setText(f'{str(math.floor(self.signal.x_vec[-1] / 60)).zfill(2)}:{str(math.floor(self.signal.x_vec[-1]) % 60).zfill(2)}')  
    ...
    def update_current_timer(self):
        ...
        self.current_input_time.setText(f'{str(math.floor(self.current_time / 60)).zfill(2)}:{str(math.floor(self.current_time) % 60).zfill(2)}')  
